...
### Added
- 10 Networking Audit Skill playbooks under `skills/` (2,300+ lines)
- Skills README with upload instructions (`skills/README.md`)
- Supported regions table in README Quick Start (Step 1)
- Skills mention in README Step 4 with importance callout

### Fixed
- `upload-knowledge.sh` updated to scan knowledge and skill docs (legacy behavior)
- `upload-knowledge.ps1` updated to include skill files (legacy behavior)
...
- Agent persona/system prompt (`prompts/agent-system-prompt.md`)
